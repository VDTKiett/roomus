            ...
            <div className="container py-4">
                <div className="row py-5">
                    <div className="col-md-4 mb-3 mb-md-0">
                        <h6 className="text-uppercase mb-3 title">Customer services</h6>
                    ...
                    <div className="col-md-4 mb-3 mb-md-0">
                        <h6 className="text-uppercase mb-3 title">Company</h6>
                        <ul className="list-unstyled mb-0">
                    ...
                    <div className="col-md-4">
                        <h6 className="text-uppercase mb-3 title">Social media</h6>
                        <ul className="list-unstyled mb-0">
                ...
                <div className="border-top pt-4" style={{ borderColor: '#1d1d1d !important' }}>
                    <div className="row">
                        ...
                        <div className="col-lg-6 text-lg-right">
                            <p className="small text-muted mb-0">Template designed by <a className="text-white reset-anchor" href="#">ROOMUS dev team</a></p>
                        </div>
                    </div>
                </div>
            </div>
