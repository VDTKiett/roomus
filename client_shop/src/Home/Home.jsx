        ...
        <div className="page-holder">
            <header className="header bg-white">
                ...
                <div className="container">
                    <section className=" pb-3 bg-cover bg-center d-flex align-items-center" style={{ backgroundImage: `url(${Image.banner})` }}>
                    ...
                    <section className="py-5" id="section_product">
                        <header>
                            ...
                            <h2 className="h5 text-uppercase mb-4">Top trending services</h2>
                        </header>
                        <div className="row">
                            {
                                products && products.map(value => (
                                    ...
                                    <div className="d-inline-block">
                                        <div className="media align-items-end">
                                            ...
                                            <div className="media-body text-left ml-3">
                                                <h6 className="text-uppercase mb-1">Realtime</h6>
                                                <p className="text-small mb-0 text-muted">Realtime room status</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4 mb-3 mb-lg-0">
                                    <div className="d-inline-block">
                                        <div className="media align-items-end">
                                            ...
                                            <div className="media-body text-left ml-3">
                                                <h6 className="text-uppercase mb-1">Online service</h6>
                                                <p className="text-small mb-0 text-muted">Book anytime, anywhere!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-4">
                                    <div className="d-inline-block">
                                        <div className="media align-items-end">
                                            ...
                                            <div className="media-body text-left ml-3">
                                                <h6 className="text-uppercase mb-1">Fast</h6>
                                                <p className="text-small mb-0 text-muted">One click, you're done!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
