...
function Cart(props) {
    ...
    return (
        <div className="container">
            <section className="py-5 bg-light bg-cover">
                <div className="container">
                        ...
                        <div className="bg-light px-4 py-3">
                            <div className="row align-items-center text-center">
                                <div className="col-md-6 mb-3 mb-md-0 text-md-left">
                                    <Link className="btn btn-link p-0 text-dark btn-sm back-btn" to={`/shop`}>
                                        <i className="fas fa-long-arrow-alt-left mr-2 back-content"> </i>Continue shopping
                                    </Link>                
                                </div>
                                <div className="col-md-6 text-md-right">
                                    ...
                                    <span className="btn btn-sm proceed-btn" onClick={onCheckout}>
                                        Proceed to checkout<i className="fas fa-long-arrow-alt-right ml-2"></i>
                                    </span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li>
                                        <form>
                                            <div className="form-group mb-0">
                                                ...
                                                <button className="btn btn-dark btn-sm btn-block apply-coupon-btn" type="submit"> <i className="fas fa-gift mr-2"></i>Apply coupon</button>
                                            </div>
                                        </form>
                                    </li>
                                </ul>
